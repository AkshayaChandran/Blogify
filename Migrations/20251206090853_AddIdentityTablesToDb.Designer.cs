...
namespace Blogify.Migrations
{
    ...
    [Migration("20251206090853_AddIdentityTablesToDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Blogify.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            Description = "Get latest LifeStyle Updates.",
                            Name = "LifeStyle"
                        });
                });

            modelBuilder.Entity("Blogify.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Blogify.Models.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Blogify.Models.Comment", b =>
                {
                    b.HasOne("Blogify.Models.Post", "Post")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("Blogify.Models.Post", b =>
                {
                    b.HasOne("Blogify.Models.Category", "Category")
                        .WithMany("Posts")
